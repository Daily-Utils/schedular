...
import { supportTicketCreateOutputDTO } from './dtos/output.dto';
...
export class SupportTicketsResolver {
    ...
    async createSupportTicket(
        ...
        return await this.supportTicketsService.createSupportTicket(createSupportTicket);
    }
    ...
    async updateSupportTicket(
        ...
        try {
            await this.supportTicketsService.updateSupportTicketStatus(updateSupportTicket);
            return {
                status: "Success",
